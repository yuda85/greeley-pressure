...
try {
   ...
   // $mail->Host = '192.168.160.7';  					// Specify main and backup SMTP servers
    ...
    //Recipients
    $mail->setFrom('noreply@fortcollinspressurewashers.com','Greeley Pressure Wash - Website step 1 Lead ');
    $mail->addAddress($to, $name);     // Add a recipient            // Name is optional
    $mail->addAddress($to_2, $name);     // Add a recipient            // Name is optional
    $mail->addReplyTo('noreply@fortcollinspressurewashers.com', 'Greeley Pressure Wash - Website step 1  Lead');
	$mail->CharSet = 'UTF-8';

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Greeley Pressure Wash Lead Form ';
    $mail->Body    = '<h1>Greeley Pressure Wash  Page Form</h1><br/>
    ...
    <thead>
        <tr style="border: 1px solid #171717;">
            ...
            <th style="border: 2px solid #171717;padding: 4px 10px;background: #f8f8f8;">Message</th>
